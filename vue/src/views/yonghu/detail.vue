    ...
    <div class="yonghu-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-text">
                ...
                <div class="detail-content">{{ map.shoujihaoma }}</div>
            </div>
            <div class="detail detail-text">
                <div class="detail-title">所在城市：</div>
                <div class="detail-content">{{ map.suozaichengshi }}</div>
            </div>
            ...
            <div class="detail detail-date">
                <div class="detail-title">生日：</div>
                <div class="detail-content">{{ map.shengri }}</div>
            </div>
            <div class="detail detail-longtext">
                <div class="detail-title">个性签名：</div>
                <div class="detail-content">{{ map.gexingqianming }}</div>
            </div>
            <div class="detail detail-longtext">
