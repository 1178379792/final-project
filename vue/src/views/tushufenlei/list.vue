    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                ...
                <el-table-column prop="fenlei" label="分类" width="130">
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/tushufenleiupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$store
                    .dispatch("tushufenlei/query", filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("tushufenlei/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
