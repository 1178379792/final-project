        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                ...
                <el-table-column prop="image" label="图片" width="100">
                    <template slot-scope="{row}"> <e-img :src="row.image" style="max-width: 120px" /> </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/lunbotuupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
        ...
        methods: {
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("lunbotu/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
