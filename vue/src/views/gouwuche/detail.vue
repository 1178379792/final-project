<template>
    <div class="gouwuche-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-select">
                ...
                <div class="detail-content">
                    <e-select-view module="tushufenlei" :value="map.fenlei" select="id" show="fenlei"></e-select-view>
                </div>
            </div>
            <div class="detail detail-number">
                <div class="detail-title">库存：</div>
                <div class="detail-content">{{ map.kucun }}</div>
            </div>
            <div class="detail detail-number">
                <div class="detail-title">购买数量：</div>
                <div class="detail-content">{{ map.goumaishuliang }}</div>
            </div>
            ...
            <div class="detail detail-money">
                <div class="detail-title">小计：</div>
                <div class="detail-content">{{ map.xiaoji }}</div>
            </div>
            <div class="detail detail-textuser">
                <div class="detail-title">购买人：</div>
                <div class="detail-content">{{ map.goumairen }}</div>
            </div>
        </div>
        <div class="mt10">
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("gouwuche/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.map = res;
                    })
