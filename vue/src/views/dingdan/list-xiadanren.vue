    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                ...
                <el-table-column prop="dingdanbianhao" label="订单编号" width="130">
                    <template slot-scope="{row}"> {{ row.dingdanbianhao }} </template>
                </el-table-column>
                <el-table-column sortable="custom" prop="dingdanjine" label="订单金额" width="80">
                    <template slot-scope="{row}"> {{ row.dingdanjine }} </template>
                </el-table-column>
                <el-table-column prop="dingdanzhuangtai" label="订单状态" width="130">
                    <template slot-scope="{row}"> {{ row.dingdanzhuangtai }} </template>
                </el-table-column>
                ...
                <el-table-column prop="xiadanren" label="下单人" width="80">
                ...
                <el-table-column label="是否支付" width="120">
                    <template slot-scope="{row}">
                        ...
                        <el-button
                            size="mini"
                            type="primary"
                            @click="$goto({path:'/admin/pay' , query:{biao:'dingdan' , id:row.id,ordersn:row.dingdanbianhao,zongji:row.dingdanjine } })"
                            v-if="row.iszf=='否'"
                        >
                            去支付
                        </el-button>
