        ...
        <el-card class="box-card">
                ...
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="分类">
                        ...
                        >
                            ...
                            <e-select-option type="option" module="tushufenlei" value="id"
                                             label="fenlei"></e-select-option
                            >
                        </el-select>
                    </el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                ...
                <el-table-column prop="fenlei" label="分类" width="80">
                    <template slot-scope="{row}">
                        <e-select-view module="tushufenlei" :value="row.fenlei" select="id"
                                       show="fenlei"></e-select-view>
                    </template>
                </el-table-column>
                <el-table-column prop="zuozhe" label="作者" width="130">
                    <template slot-scope="{row}"> {{ row.zuozhe }}</template>
                </el-table-column>
                <el-table-column prop="chubanshe" label="出版社" width="130">
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/tushuxinxidetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/tushuxinxiupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$store
                    .dispatch("tushuxinxi/query", filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("tushuxinxi/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
