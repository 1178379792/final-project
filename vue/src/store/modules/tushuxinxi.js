...
const actions = {
    selectAll(
        ...
        return new Promise((resolve, reject) => {
            if (content.state.status == 0) {
                ...
                http.get("/api/tushuxinxi/selectAll").then(
                    (res) => {
                        if (res.code == 0) {
    ...
    filter(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/tushuxinxi/filter", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    query(content, data) {
        // 分页查询数据
        return new Promise((resolve, reject) => {
            http.post("/api/tushuxinxi/selectPages", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    delete(content, data) {
        // 删除数据
        return new Promise((resolve, reject) => {
            http.post("/api/tushuxinxi/delete", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
