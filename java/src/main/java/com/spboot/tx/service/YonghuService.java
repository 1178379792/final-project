...
public class YonghuService {
    ...
    public ResponseData<Yonghu> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Yonghu>> selectAll(Wrapper<Yonghu> query) {
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Yonghu>> filter(Map<String, Object> map) {
        Class<Yonghu> aClass = Yonghu.class;
        com.jntoo.db.QueryWrapper<Yonghu> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Yonghu> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Yonghu entityData, Map post) {
    ...
    public ResponseData<Object> update(Yonghu entityData, Map post) {
