...
@Service
public class DingdandingdanxinxiService {

    @Resource
    private DingdandingdanxinxiMapper mapper;

    public ResponseData<Dingdandingdanxinxi> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Dingdandingdanxinxi>> selectAll(Wrapper<Dingdandingdanxinxi> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Dingdandingdanxinxi>> selectAll() {
        QueryWrapper<Dingdandingdanxinxi> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Dingdandingdanxinxi> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Dingdandingdanxinxi> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Dingdandingdanxinxi> wrapper = Wrappers.query();
        ...
        if (!StringUtil.isNullOrEmpty(map.get("tushuxinxiid"))) {
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Dingdandingdanxinxi>> filter(Map<String, Object> map) {
        Class<Dingdandingdanxinxi> aClass = Dingdandingdanxinxi.class;
        com.jntoo.db.QueryWrapper<Dingdandingdanxinxi> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Dingdandingdanxinxi> wrapper, IPage page) {
    ...
    public ResponseData insert(Dingdandingdanxinxi entityData, Map post) {
        Info.handlerNullEntity(entityData);

        mapper.insert(entityData);
        if (entityData.getId() != null) {
            Integer charuid = entityData.getId();
            DB.execute("UPDATE dingdandingdanxinxi SET xiaoji=(goumaishuliang*jiage) WHERE id='" + charuid + "'");
    ...
    public ResponseData<Object> update(Dingdandingdanxinxi entityData, Map post) {
        mapper.updateById(entityData);

        Integer charuid = entityData.getId();
        DB.execute("UPDATE dingdandingdanxinxi SET xiaoji=(goumaishuliang*jiage) WHERE id='" + post.get("id") + "'");
